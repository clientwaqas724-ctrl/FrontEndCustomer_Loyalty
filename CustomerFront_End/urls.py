...
######################################################################################################################
    ...
    path('merchants1/', views.merchant_list1, name='merchant_list1'),
    path('merchants1/add/', views.add_merchant1, name='add_merchant1'),
    path('merchants1/update/<uuid:merchant_id>/', views.update_merchant1, name='update_merchant1'),
    path('merchants1/delete/<uuid:merchant_id>/', views.delete_merchant1, name='delete_merchant1'),
    ########################################################################################
